...
date: 2021-03-30
excerpt: "A real-time write-up of two Bret Victor talks on programming, interface design and the spatial representation of information."
categories: [Tech💡]
comments: true
image:
  feature: feature/bret-victor.PNG
  rounded_thumbnail: true
permalink: /articles/2021-03/bret-victor
---

<!-- Restored from the archived article text supplied by Corrie.
Archive: https://web.archive.org/web/20220118015206/https://corrie.dev/articles/2021-03/bret-victor
The original front matter was unavailable; title and date come from the supplied page, and the excerpt/category are restoration additions.
Local images and section placements confirmed by Corrie; original link destinations still need recovery.
-->
...
![Bret Victor presenting a historical demonstration of spatial information on screen]({{ site.url }}/img/spatial-1.PNG)

![Network diagram showing nodes and their connections]({{ site.url }}/img/spatial-2.png)
...
![GRAIL 1968 demonstration showing hand-drawn flowcharts recognised as program elements]({{ site.url }}/img/visual-1.PNG)
...
![Smalltalk browser with separate panes for navigating and editing code]({{ site.url }}/img/small-talk.PNG)
...
![Bret Victor presenting Carl Hewitt’s Actor Model from 1973]({{ site.url }}/img/actor.PNG)

## Humane Representation of Thought

<!-- No body text appeared under this heading in the supplied archive text; check the original capture for an embedded video. -->

## Closing Thoughts

<!-- No body text appeared under this heading in the supplied archive text. -->

## Further Reading

Check out the following links for inspiration and further reading about this topic

<!-- TODO: Recover original destinations for these six links; labels preserved from the supplied archive text. -->
...
<!-- Email behaviour restored using the existing site's draft-template implementation. -->
<script>
var email;
